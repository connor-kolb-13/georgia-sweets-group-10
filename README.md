...
<p> We were all present for these standup meetings. We also inivited another group to a call (group 6) hosted by Mason where we got feedback throughout the process of creating the page. This call allowed us to implement the feedback given and see suggestions from an angle that was outside of our group's perspective. We observed that this was helpful to figure out if we were on the right track with the client's hopes for this project. For the other group's project, we observed an application portal where job applicant information is uploaded and preferences are selected to match specific applicant requirements. We offered formatting and stylistic suggestions for the web page to make it more attractive to users, but overall we really liked the idea and can see how it will be helpful to group 6's client!</p>
